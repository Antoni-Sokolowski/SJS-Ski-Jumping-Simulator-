...
from src.judges import Judge, JudgePanel
...
from utils.parameter_converters import (
    slider_to_drag_coefficient, drag_coefficient_to_slider,
    slider_to_jump_force, jump_force_to_slider,
    slider_to_lift_coefficient, lift_coefficient_to_slider,
    slider_to_drag_coefficient_flight, drag_coefficient_flight_to_slider,
    style_to_frontal_area, frontal_area_to_style, apply_style_physics
)
