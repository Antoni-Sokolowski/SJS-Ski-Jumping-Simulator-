...
class Jumper:
    def __init__(self,
                 ...
                 # --- NAJAZD ---
                 inrun_drag_coefficient: float = 0.5,           # Współczynnik oporu aerodynamicznego zawodnika w pozycji najazdowej
                 inrun_frontal_area: float = 0.45,              # Powierzchnia czołowa zawodnika w pozycji najazdowej
                 ...
                 # --- LOT ---
                 flight_drag_coefficient: float = 0.01,         # Współczynnik oporu aerodynamicznego zawodnika w locie
                 flight_frontal_area: float = 0.4,              # Powierzchnia czołowa zawodnika w locie
